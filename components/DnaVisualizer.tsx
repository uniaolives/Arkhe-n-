...
const DnaVisualizer: React.FC<DnaVisualizerProps> = ({ active, melodyActive }) => {
    ...
    <div className="relative h-full w-full flex items-center justify-center">
      <div className="flex flex-col gap-2 items-center">
        {nodes.map((_, i) => (
          <div
            ...
            style={{
              transform: `rotate(${i * 18 + (melodyActive ? Math.sin(Date.now() / 500) * 5 : 0)}deg) scale(${0.8 + Math.sin(i / 2) * 0.2})`,
      ...
      {melodyActive && (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
           <div className="text-[8px] text-white font-bold tracking-[0.3em] uppercase animate-pulse">
             CASSINI-FINNEY MELODY // 3AA70
           </div>
        </div>
      )}
    </div>
